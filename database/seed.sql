...
(36, 'equipment.create', "Créer un ustensile canonique")
AS new_permissions
ON DUPLICATE KEY UPDATE
...
FROM (
  ...
  UNION ALL SELECT 'CatalogManager', 'equipment.create'
  ...
  UNION ALL SELECT 'SuperAdmin', 'equipment.create'
...
-- Équipments
-- =====================================================
INSERT INTO Equipments (Name, NormalizedName, Slug) VALUES
('Aiguille à brider', 'aiguille a brider', 'aiguille-a-brider'),
('Attendrisseur à viande', 'attendrisseur a viande', 'attendrisseur-a-viande'),
('Autocuiseur', 'autocuiseur', 'autocuiseur'),
('Balance de cuisine', 'balance de cuisine', 'balance-de-cuisine'),
('Batteur électrique', 'batteur electrique', 'batteur-electrique'),
('Bocal', 'bocal', 'bocal'),
('Bol mélangeur', 'bol melangeur', 'bol-melangeur'),
('Bouilloire', 'bouilloire', 'bouilloire'),
('Brosse à pâtisserie', 'brosse a patisserie', 'brosse-a-patisserie'),
('Broche', 'broche', 'broche'),
('Casserole', 'casserole', 'casserole'),
('Casserole à lait', 'casserole a lait', 'casserole-a-lait'),
('Cercle à pâtisserie', 'cercle a patisserie', 'cercle-a-patisserie'),
('Chalumeau de cuisine', 'chalumeau de cuisine', 'chalumeau-de-cuisine'),
('Chinois', 'chinois', 'chinois'),
('Ciseaux de cuisine', 'ciseaux de cuisine', 'ciseaux-de-cuisine'),
('Corne de pâtisserie', 'corne de patisserie', 'corne-de-patisserie'),
('Couperet', 'couperet', 'couperet'),
('Coupe-œuf', 'coupe oeuf', 'coupe-uf'),
('Couteau à pain', 'couteau a pain', 'couteau-a-pain'),
('Couteau d''office', 'couteau d office', 'couteau-d-office'),
('Couteau de cuisine', 'couteau de cuisine', 'couteau-de-cuisine'),
('Couteau éminceur', 'couteau eminceur', 'couteau-eminceur'),
('Crêpière', 'crepiere', 'crepiere'),
('Cuiseur vapeur', 'cuiseur vapeur', 'cuiseur-vapeur'),
('Cuillère en bois', 'cuillere en bois', 'cuillere-en-bois'),
('Cul-de-poule', 'cul de poule', 'cul-de-poule'),
('Découpoir', 'decoupoir', 'decoupoir'),
('Essoreuse à salade', 'essoreuse a salade', 'essoreuse-a-salade'),
('Faitout', 'faitout', 'faitout'),
('Film alimentaire', 'film alimentaire', 'film-alimentaire'),
('Fouet', 'fouet', 'fouet'),
('Four', 'four', 'four'),
('Fourchette de cuisine', 'fourchette de cuisine', 'fourchette-de-cuisine'),
('Friteuse', 'friteuse', 'friteuse'),
('Gant de cuisine', 'gant de cuisine', 'gant-de-cuisine'),
('Gaufrier', 'gaufrier', 'gaufrier'),
('Grille-pain', 'grille pain', 'grille-pain'),
('Grille de refroidissement', 'grille de refroidissement', 'grille-de-refroidissement'),
('Hachoir', 'hachoir', 'hachoir'),
('Lèchefrite', 'lechefrite', 'lechefrite'),
('Louche', 'louche', 'louche'),
('Mandoline', 'mandoline', 'mandoline'),
('Marmite', 'marmite', 'marmite'),
('Maryse', 'maryse', 'maryse'),
('Mixeur', 'mixeur', 'mixeur'),
('Moule à cake', 'moule a cake', 'moule-a-cake'),
('Moule à manqué', 'moule a manque', 'moule-a-manque'),
('Moule à muffins', 'moule a muffins', 'moule-a-muffins'),
('Moule à soufflé', 'moule a souffle', 'moule-a-souffle'),
('Moule à tarte', 'moule a tarte', 'moule-a-tarte'),
('Moule en silicone', 'moule en silicone', 'moule-en-silicone'),
('Papier aluminium', 'papier aluminium', 'papier-aluminium'),
('Papier cuisson', 'papier cuisson', 'papier-cuisson'),
('Passoire', 'passoire', 'passoire'),
('Pelle à tarte', 'pelle a tarte', 'pelle-a-tarte'),
('Pilon', 'pilon', 'pilon'),
('Pince de cuisine', 'pince de cuisine', 'pince-de-cuisine'),
('Pinceau de cuisine', 'pinceau de cuisine', 'pinceau-de-cuisine'),
('Planche à découper', 'planche a decouper', 'planche-a-decouper'),
('Plaque de cuisson', 'plaque de cuisson', 'plaque-de-cuisson'),
('Plateau tournant', 'plateau tournant', 'plateau-tournant'),
('Poche à douille', 'poche a douille', 'poche-a-douille'),
('Poêle', 'poele', 'poele'),
('Poêle à crêpes', 'poele a crepes', 'poele-a-crepes'),
('Presse-agrumes', 'presse agrumes', 'presse-agrumes'),
('Presse-purée', 'presse puree', 'presse-puree'),
('Ramequin', 'ramequin', 'ramequin'),
('Robot de cuisine', 'robot de cuisine', 'robot-de-cuisine'),
('Rouleau à pâtisserie', 'rouleau a patisserie', 'rouleau-a-patisserie'),
('Râpe', 'rape', 'rape'),
('Sac de congélation', 'sac de congelation', 'sac-de-congelation'),
('Saladier', 'saladier', 'saladier'),
('Sauteuse', 'sauteuse', 'sauteuse'),
('Siphon de cuisine', 'siphon de cuisine', 'siphon-de-cuisine'),
('Spatule', 'spatule', 'spatule'),
('Tamis', 'tamis', 'tamis'),
('Terrine', 'terrine', 'terrine'),
('Verre doseur', 'verre doseur', 'verre-doseur'),
('Wok', 'wok', 'wok'),
('Zesteur', 'zesteur', 'zesteur'),
('Écumoire', 'ecumoire', 'ecumoire'),
('Épluche-légumes', 'epluche legumes', 'epluche-legumes')
AS new_row ON DUPLICATE KEY UPDATE NormalizedName = new_row.NormalizedName, Slug = new_row.Slug;
