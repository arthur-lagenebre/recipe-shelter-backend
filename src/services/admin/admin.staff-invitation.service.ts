...
export class StaffInvitationService {
  ...
  constructor(private readonly invitations: StaffInvitationRepository, private readonly mailer: StaffInvitationMailer, private readonly auditActions: AdminAuditActionRunner, private readonly appBaseUrl: string, options: StaffInvitationServiceOptions = {}) {
