...
export interface AdminIngredientRepository {
    ...
    merge(input: AdminIngredientMergeInput, db: PoolConnection): Promise<AdminIngredientMergeResult>;
    findAliases(
        ingredientId: number,
    ...
    isMergeSourceNameAlias(ingredientId: number, aliasId: number, db: PoolConnection): Promise<boolean>;
