...
export type AdminIngredientWriteResult =
    { status: 'written'; ingredient: Ingredient } | { status: 'normalized_name_taken' } | { status: 'slug_taken' };
...
export type AdminIngredientAliasWriteResult = { status: 'written'; alias: IngredientAlias } | { status: 'alias_taken' };
