...
import type { AdminCreateIngredientAliasCommand, AdminCreateIngredientCommand, AdminMergeIngredientCommand, AdminUpdateIngredientAliasCommand, AdminUpdateIngredientCommand } from '../../services/admin/admin.ingredients.service.js';
...
export function parseUpdateAdminIngredientBody(body: unknown): AdminUpdateIngredientCommand {
  ...
  const name = body.name === undefined
    ? undefined
    : parseRequiredName(body.name, 'Ingredient', 'ADMIN_INGREDIENTS');
  const slug = parseOptionalSlug(body.slug);
...
export function parseAdminIngredientActionReasonBody(
  body: unknown,
...
export function parseMergeAdminIngredientBody(body: unknown): AdminMergeIngredientCommand {
  ...
  return {
    targetIngredientId: parseBodyId(
      ...
      'Merge target ingredient id',
      'ADMIN_INGREDIENTS_MERGE_BAD_TARGET_ID'
    ),
...
export function parseUpdateAdminIngredientAliasBody(body: unknown): AdminUpdateIngredientAliasCommand {
  ...
  const name = body.name === undefined
    ? undefined
    : parseRequiredName(body.name, 'Ingredient alias', 'ADMIN_INGREDIENT_ALIASES');
