...
export const adminAuthorizationPolicies = [
    ...
    { method: 'post', path: '/catalog-proposals/equipments/:id/accept', permission: PERMISSIONS.catalogManage },
    ...
    { method: 'post', path: '/catalog-proposals/equipments/:id/associate', permission: PERMISSIONS.catalogManage },
