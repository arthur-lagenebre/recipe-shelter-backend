...
import type { CatalogProposalListFilters, CatalogProposalStatus, CatalogProposalType } from '../../repositories/catalog/catalog-proposals.types.js';
import type { AcceptIngredientCatalogProposalCommand, AcceptTagCatalogProposalCommand, AssociateIngredientCatalogProposalCommand, AssociateTagCatalogProposalCommand, ConvertCatalogProposalToAliasCommand } from '../../services/admin/admin.catalog-proposals.service.js';
...
export function parseAdminCatalogProposalListFilters(query: unknown): CatalogProposalListFilters {
  ...
  const recipeId = query.recipeId === undefined
    ? undefined
    : parseQueryId(query.recipeId, 'Recipe id', 'ADMIN_CATALOG_PROPOSALS_BAD_RECIPE_ID');
  const authorUserId = query.authorUserId === undefined
    ? undefined
