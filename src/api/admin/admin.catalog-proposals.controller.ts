...
} from './admin.catalog-proposals.dto.js';
...
export function createAdminCatalogProposalsController(proposals: AdminCatalogProposalService) {
    return {
        list: asyncHandler(async (req, res) => {
            ...
            const pagination = parsePaginationQuery(req.query, DEFAULT_ADMIN_CATALOG_PROPOSAL_LIMIT, 'ADMIN_CATALOG_PROPOSALS_PAGINATION');
